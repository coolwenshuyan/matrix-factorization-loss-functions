...
DATASETS_CONFIG = {
    'M100K_test': {
        'raw_data_path': 'E:\工作资料\科研\论文\写作\使用混合分段损失函数增强矩阵分解用于推荐\矩阵分解损失函数code\dataset\\20201202M100K_test.txt',           # 原始数据文件路径
        'preprocessed_dir': './preprocessed_data/M100K_test',  # 预处理文件保存路径
        'description': 'M100K_test评分数据集'
    },
        'Netflix': {
        'raw_data_path': 'E:\工作资料\科研\论文\写作\使用混合分段损失函数增强矩阵分解用于推荐\矩阵分解损失函数code\dataset\\20201202NetFlix_data_all_random.txt',           # 原始数据文件路径
        'preprocessed_dir': './preprocessed_data/Netflix',  # 预处理文件保存路径
